...
{DataModule1.qryMain.Active:=False;
   ...
   DataModule1.qryMain.SQL.Text:='Select Count(код_студента) as C From Архив_студентов Where Трудоустроен=true';
   DataModule1.qryMain.ExecSQL;
   DataModule1.qryMain.Active:=True;        }


  //lbl1.Caption:='Трудоустроеных: '+DataModule1.qryMain.FieldValues['C'];
end;
