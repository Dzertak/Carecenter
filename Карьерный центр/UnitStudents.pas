...
command:='Insert into Архив_студентов(Трудоустроен,ФИО,Код_специальности,Группа,Год_поступления,Год_выпуска,Примечание) '+
'Select false, ФИО,Код_специальности,Группа,Год_поступления,Год_выпуска,Примечание+". '+note+'" From Студенты '+
